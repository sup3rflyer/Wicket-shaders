...
#define RED_INTENSITY_MULTIPLIER 1.2
#define GREEN_INTENSITY_MULTIPLIER 1.1
#define BLUE_INTENSITY_MULTIPLIER 1.0

#define RED_VARIANCE_SCALE 1.1
...
#define RED_MID 0.25
#define GREEN_MID 0.25
#define BLUE_MID 0.25

#define RED_STEEPNESS 5.0
#define GREEN_STEEPNESS 5.0
#define BLUE_STEEPNESS 5.0

#define RED_SATURATION 0.7
#define GREEN_SATURATION 0.6
...
// 3-Tap (Coarse), 2-Tap (Medium), 1-Tap (Fine)
const float weights_red[7] = { 0.01465, 0.08312, 0.23556, 0.33335, 0.23556, 0.08312, 0.01465 };
